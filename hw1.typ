...
*1.*我们可以使用信号博弈的框架来描述这个情形，该框架包含参与人、类型、行动、信念和收益。

- Players:
  - 发送方 (Sender, S): 年轻人（求职者）。
  - 接收方 (Receiver, R): 雇主。
- Timing:
  + “自然”（Nature）决定年轻人的类型 θ（即能力），并只有年轻人自己知道。
  + 年轻人（发送方）根据自己的类型，选择一个行动（发送一个信号）
  + 雇主（接收方）观察到年轻人的行动，但不知道其真实类型。雇主根据观察到的信号更新自己的信念，并决定是否雇佣
  + 双方根据年轻人的类型、年轻人的行动和雇主的行动获得各自的收益。
- Types:
  - 年轻人的类型空间为$theta in {"高能力","低能力"}$
  - 根据题设，自然选择类型的先验概率为：$P(theta = "高能力")=1/4, P(theta = "低能力")=3/4$
- Actions:
  - 年轻人的行动空间为$M={"进入大学","国外旅行"}$
  - 雇主的行动空间为$A={"雇用","不雇用"}$
- Beliefs:
  - 雇主的信念是指在观察到特定信号后，对年轻人是高能力的概率判断。我们用$mu ("高能力"|"行动")$
- Payoffs:
...
*2.*首先，我们来确定雇主的最优策略。雇主的决策取决于他对求职者是高能力的信念$mu$。 

雇主选择“雇用”的期望收益为：$ bb(E)[U("雇用")]= mu dot 8 + (1 - mu) dot 0 = 8 mu $
雇主选择“不雇用”的期望收益为：$ bb(E)[U("不雇用")] = mu dot 3 + (1 - mu) dot 3 = 3 $

雇主会选择雇用，当且仅当$bb(E)[U("雇用")] >= bb(E)[U("不雇用")]$，即
$ 8 mu >= 3 => mu >= 3/8 $
...
现在我们寻找两种类型的均衡：分离均衡和混同均衡。

*类型一：分离均衡*

在分离均衡中，不同类型的年轻人会选择不同的行动。

假设：高能力者选择进入大学，低能力者选择国外旅行

+ 信念：在这个均衡路径上，雇主观察到“进入大学”便知其为高能力者，观察到“国外旅行”便知其为低能力者。$ mu ("高能力"| "进入大学")=1 $  $ mu("高能力"| "国外旅行")=0 $
+ 雇主行动:
  - 观察到“进入大学”：$mu = 1 > 3/8$，雇主选择雇用。
  - 观察到“国外旅行”：$mu = 0 < 3/8$，雇主选择不雇用。
+ 年轻人动机检验:
  - 高能力者：选择进入大学(均衡路径)，被雇用，收益为4.若偏离至国外旅行，不被雇用，收益为3.高能力者不会偏离。
  - 低能力者：选择国外旅行(均衡路径)，不被雇用，收益为3。若偏离至进入大学，收益为2.低能力者不会偏离。

这是一个有效的精炼贝叶斯纳什均衡。

策略：高能力年轻人选择进入大学，低能力年轻人选择国外旅行。雇主雇用上大学的人，不雇用去旅行的人。

信念：雇主相信上大学的人是高能力的($mu=1$)，去旅行的人是低能力的($mu=0$)。

*类型二：混同均衡*

在混同均衡中，所有类型的年轻人选择相同的行动。

假设：所有年轻人都选择国外旅行

+ 信念：均衡路径上: 雇主观察到“国外旅行”，但他无法分辨求职者类型，因此他的信念等于先验概率：$mu("高能力"|"国外旅行")=P("高能力")=1/4$.非均衡路径上: 雇主观察到“进入大学”。由于这在均衡中不会发生，贝叶斯法则不适用。我们可以设定一个非均衡路径信念$mu_U = mu("高能力"|"进入大学")$
+ 雇主行动:观察到“国外旅行”：$mu= 1/4 < 3/8$，雇主选择不雇用。观察到“进入大学”：行动取决于$mu_U$。为了维持均衡，我们需要设定一个让年轻人不想偏离的信念。最能阻止偏离的信念是让雇主不雇用，即要求$mu_U < 3/8$。
+ 年轻人动机检验: 假设非均衡路径信念为$mu_U=0$，则雇主在任何情况下都不会雇用。
   - 高能力者:选择国外旅行（均衡路径），不被雇用，收益为 3。若偏离至进入大学，$mu_U=0$，同样不被雇用，收益为 1。高能力者不会偏离。
   - 低能力者:选择国外旅行（均衡路径），不被雇用，收益为 3。若偏离至进入大学，$mu_U=0$，同样不被雇用，收益为 -3。低能力者不会偏离。

这是一个有效的精炼贝叶斯纳什均衡。

策略：所有年轻人（无论高能力或低能力）都选择国外旅行。雇主不雇用任何求职者（无论其是旅行还是上大学）。

信念：雇主相信去旅行的人是高能力的概率为$1/4$。雇主相信上大学的人是高能力的概率$mu_U < 3/8$（非均衡路径信念）。

综上所述，该博弈存在两个精炼贝叶斯纳什均衡：
+ 一个分离均衡: 高能力者通过上大学来彰显自己，并成功获得工作；低能力者则选择旅行。教育在这里成功地起到了信号作用。
+ 一个混同均衡: 所有人都选择旅行，雇主因为无法分辨好坏而选择不雇用任何人。教育在此未能起到信号作用，导致了一个对高能力者和雇主都不利的结果。
