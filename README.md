...
<details>
<summary><strong>Lecture 12: 隐私与外部性问题</strong></summary>

> **Abstract**：第十二讲围绕数据定价中的隐私与外部性问题展开，内容可分为两大模块：

> **一、隐私视角下的数据定价**
首先从隐私成本出发，构建了卖家因差分隐私泄露产生的效用损失模型，证明若机制满足ε-差分隐私，则卖家效用下降不会超过(1–e⁻ᵋ)v，可近似为线性函数εv，用以刻画隐私成本。其次探讨了隐私数据获取机制设计：在预算约束与准确率目标下，针对隐私成本与数据相关性问题，分析了当隐私成本先验未知或已知时不同机制的可行性与偏差控制。第三，论述隐私数据交易对社会福利的影响：在平台实施价格歧视与三级价格歧视场景下，建立厂商利润与消费者福利的三条线性约束，描绘福利三角并通过示例计算最优垄断定价及对应福利分布。最后从微观与宏观层面探讨隐私数据使用政策与产权归属问题，分析平台优化推荐与价格歧视的权衡，以及数据非竞争性与乘数效应对共享激励的影响。

> **二、外部性问题**
从买家角度，阐述不同买家间因数据竞合产生的市场占有率与投资组合外部性；从卖家角度，分析高相关性隐私数据出售导致的价值贬损及均衡价格下降。通过对隐私与外部性问题的系统梳理，本讲为后续构建兼顾隐私保护、公平定价与外部性调节的数字经济市场机制提供了理论基础与应用思路。
